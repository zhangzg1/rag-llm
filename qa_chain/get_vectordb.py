...
sys.path.append("../")
from database.create_db import create_vectordb_zhipu
...
if __name__ == '__main__':
    vectordb = get_vectordb(file_path="/home/zhangzg/LLM/rags/database/data",
                            persist_path="/home/zhangzg/LLM/rags/vector_db/all", embedding_model="zhipuai")
